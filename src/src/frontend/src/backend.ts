...
export class Backend implements backendInterface {
    ...
    async addFreeNote(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFreeNote(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addYouTubeLecture(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addYouTubeLecture(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteFreeNote(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteFreeNote(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteYouTubeLecture(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteYouTubeLecture(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFreeNotes(): Promise<Array<FreeNote>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFreeNotes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getYouTubeLectures(): Promise<Array<YouTubeLecture>> {
        if (this.processError) {
            try {
                const result = await this.actor.getYouTubeLectures();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitReview(arg0: string, arg1: string, arg2: bigint, arg3: string): Promise<void> {
        if (this.processError) {
            try {
